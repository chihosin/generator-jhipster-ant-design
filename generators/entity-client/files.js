    ...
    client: [
        {
            ...
            templates: [
                ...
                {
                    file: 'entities/entity-component-list.component.scss',
                    renameTo: generator => `entities/${generator.entityFolderName}/components/${generator.entityFileName}-list.component.scss`
                },
                {
